...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0B33FF);
  late Color secondary = const Color(0xFFEAB308);
  late Color tertiary = const Color(0xFF22C55E);
  late Color alternate = const Color(0xFFD71F1F);
