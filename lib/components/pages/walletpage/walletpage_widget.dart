...
class _WalletpageWidgetState extends State<WalletpageWidget> {
  ...
  Widget build(BuildContext context) {
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(10.0, 60.0, 10.0, 100.0),
    ...
    showDialog(
      context: context,
      barrierColor: Colors.black54, // background dim effect
      builder: (context) => const Dialog(
        backgroundColor: Colors.transparent, // no white box
        insetPadding: EdgeInsets.all(10), // optional padding
        child: SpinWheelWidget(), // directly show your widget
      ),
    );                               },
                                    ),
                                    Text(
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(AdsPageWidget.routeName);
                                },
                                child: Container(
                                  width: 93.93,
                                  height: 92.4,
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(ChallengePageWidget.routeName);
                                },
                                child: Container(
                                  width: 92.8,
                                  height: 92.5,
